...
img = Image.open('./Images/karadi.jfif').convert('L')          #IMAGE OPENING HERE!!
...
for i in range(4,8):
    ...
    distort_img.save(f"./images/distort/test_img{i-4}.jpg")
...
for i in range(4):
    for j in range(3,10,2):
        ...
        # pic.show()
        pic.save(f"./images/results/abd_recover{i+1}.{j}.jpg")
